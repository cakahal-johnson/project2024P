...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Initialize buttons
        Button btnUserDashboard = view.findViewById(R.id.btn_user_dashboard);
        Button btnContactPage = view.findViewById(R.id.btn_contact_page);
        ...
        btnContactPage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
