...
//        Importing the Log class i on the onCreate Called
//        Log.i("MainActivity", "onCreate Called")
    ...
    //    Implementing the onStart() method using Control+O
