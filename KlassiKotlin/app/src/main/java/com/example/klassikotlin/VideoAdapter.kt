package com.example.klassikotlin
...
import com.example.klassikotlin.databinding.ActivityMainBinding
import com.example.klassikotlin.databinding.ListVideoBinding
...
class VideoAdapter(
    ...
    class VideoViewHolder(
        ...
        fun setVideoPath(url: String) {
            ...
            mediaSource = ProgressiveMediaSource.Factory(dataSourceFactory).createMediaSource(mediaItem.fromUri(
                Uri.parse(uri)))
